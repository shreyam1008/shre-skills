...
Last checked: 18 September 2026 (UTC)

| Channel | Version | Status | Evidence / next action |
| --- | --- | --- | --- |
| GitHub repository | `main` (unreleased) | **Live** | Public repository contains 21 active skills, optional references, and install migration documentation. The current branch candidate keeps ask-first decisions and adds strict database guardrails; public `main` remains unchanged until merge. |
